...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    subtitle: '学习，分享。',
    // site description
    description: '一个专注于技术分享与个人成长的博客，记录我的学习历程与心得体会，旨在与大家共同进步。',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: false, // true | false
    // author name
    author: 'xepher',
    // site url
    url: 'https://stay20.sakurabus.com',
    // base path
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/xepher',
      },
      {
        name: 'Douban',
        url: 'https://www.douban.com/people/xepher',
      },
      // {
      //   name: 'X',
      //   url: 'https://x.com/feiyuwan',
      // },
    ],
